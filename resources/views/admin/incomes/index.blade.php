    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            <div class="btn-group" role="group" aria-label="View mode">
                <a href="{{ route('admin.incomes.index', ['view_mode' => 'personal']) }}" class="btn btn-secondary{{ $viewMode == 'personal' ? ' active' : '' }}">Personal</a>
                <a href="{{ route('admin.incomes.index', ['view_mode' => 'entity']) }}" class="btn btn-secondary{{ $viewMode == 'entity' ? ' active' : '' }}">Entity</a>
            </div>
        </div>
    </div>
@endcan
                    ...
                    @foreach($incomes as $key => $income)
                        <tr data-entry-id="{{ $income->id }}">
                            ...
                            <td>
                                ...
                                @can('income_edit')
                                    @if ($income->created_by_id == Auth::user()->id)
